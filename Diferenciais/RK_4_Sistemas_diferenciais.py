...
sistema(0,0.5,0,1,1,0.1)
#para y
r1 = sistema(0,0.5,0,1,1,0.1)[0]
r2 = sistema(0,0.5,0,1,1,0.1/2)[0]
r3 = sistema(0,0.5,0,1,1,0.1/4)[0]
print("y1: ", r1)
print("y2: ", r2)
print("y3: ", r3) 
...
z1 = sistema(0,0.5,0,1,1,0.1)[1]
z2 = sistema(0,0.5,0,1,1,0.1/2)[1]
z3 = sistema(0,0.5,0,1,1,0.1/4)[1]
print("z1: ", z1)
print("z2: ", z2)
print("z3: ", z3) 
